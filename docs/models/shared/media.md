...
```typescript
import { HasVoiceActivity, Media, StreamType } from "@lukehagar/plexjs/models/shared";
...
| `hasVoiceActivity`                                                                                                                         | [shared.HasVoiceActivity](../../models/shared/hasvoiceactivity.md)                                                                         | :heavy_minus_sign:                                                                                                                         | Voice activity detection availability flag returned by PMS.<br/>PMS returns this as string values (`"0"` or `"1"`) instead of a JSON boolean.<br/> | 1                                                                                                                                          |
...
| `part`                                                                                                                                     | [shared.Part](../../models/shared/part.md)[]                                                                                               | :heavy_minus_sign:                                                                                                                         | N/A                                                                                                                                        |                                                                                                                                            |
