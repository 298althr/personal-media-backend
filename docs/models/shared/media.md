...
| `hasVoiceActivity`                                                                                                                  | *shared.HasVoiceActivity*                                                                                                           | :heavy_minus_sign:                                                                                                                  | Voice activity detection availability flag returned by PMS.<br/>PMS may return this as a boolean or as string values (`"0"` or `"1"`).<br/> | 0                                                                                                                                   |
| `height`                                                                                                                            | *number*                                                                                                                            | :heavy_minus_sign:                                                                                                                  | N/A                                                                                                                                 | 544                                                                                                                                 |
| `id`                                                                                                                                | *number*                                                                                                                            | :heavy_check_mark:                                                                                                                  | N/A                                                                                                                                 | 1                                                                                                                                   |
| `optimizedForStreaming`                                                                                                             | [shared.OptimizedForStreaming](../../models/shared/optimizedforstreaming.md)                                                        | :heavy_minus_sign:                                                                                                                  | N/A                                                                                                                                 |                                                                                                                                     |
