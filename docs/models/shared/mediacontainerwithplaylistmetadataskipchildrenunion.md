...
### `shared.MediaContainerWithPlaylistMetadataSkipChildrenEnum`

```typescript
const value: shared.MediaContainerWithPlaylistMetadataSkipChildrenEnum =
  MediaContainerWithPlaylistMetadataSkipChildrenEnum.Zero;
```
