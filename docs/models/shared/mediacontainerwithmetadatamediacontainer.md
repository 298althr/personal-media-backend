...
```typescript
import { HasVoiceActivityEnum, MediaContainerWithMetadataMediaContainer, StreamType } from "@lukehagar/plexjs/models/shared";

let value: MediaContainerWithMetadataMediaContainer = {
  metadata: [
    {
      title: "<value>",
      type: "<value>",
