...
```typescript
import { HasVoiceActivityEnum, MediaContainerWithMetadata, StreamType } from "@lukehagar/plexjs/models/shared";
...
| ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| `mediaContainer`                                                                                                   | [shared.MediaContainerWithMetadataMediaContainer](../../models/shared/mediacontainerwithmetadatamediacontainer.md) | :heavy_minus_sign:                                                                                                 | N/A                                                                                                                |