...
| `hasVoiceActivity`                                                                                                                  | *shared.MediaContainerWithDecisionHasVoiceActivityUnion*                                                                            | :heavy_minus_sign:                                                                                                                  | Voice activity detection availability flag returned by PMS.<br/>PMS may return this as a boolean or as string values (`"0"` or `"1"`).<br/> | 0                                                                                                                                   |
