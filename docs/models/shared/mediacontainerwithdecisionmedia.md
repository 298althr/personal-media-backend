...
| `hasVoiceActivity`                                                                                                                         | [shared.MediaContainerWithDecisionHasVoiceActivity](../../models/shared/mediacontainerwithdecisionhasvoiceactivity.md)                     | :heavy_minus_sign:                                                                                                                         | Voice activity detection availability flag returned by PMS.<br/>PMS returns this as string values (`"0"` or `"1"`) instead of a JSON boolean.<br/> | 1                                                                                                                                          |
