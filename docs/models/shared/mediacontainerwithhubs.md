...
```typescript
import { HasVoiceActivityEnum, MediaContainerWithHubs, StreamType } from "@lukehagar/plexjs/models/shared";
...
| ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| `mediaContainer`                                                                                           | [shared.MediaContainerWithHubsMediaContainer](../../models/shared/mediacontainerwithhubsmediacontainer.md) | :heavy_minus_sign:                                                                                         | N/A                                                                                                        |