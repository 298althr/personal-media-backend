...
```typescript
import { HasVoiceActivityEnum, MediaContainerWithSubscription, StreamType } from "@lukehagar/plexjs/models/shared";
...
| -------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| `mediaContainer`                                                                                                           | [shared.MediaContainerWithSubscriptionMediaContainer](../../models/shared/mediacontainerwithsubscriptionmediacontainer.md) | :heavy_minus_sign:                                                                                                         | N/A                                                                                                                        |