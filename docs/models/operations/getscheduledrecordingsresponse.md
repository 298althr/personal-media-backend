...
```typescript
import { GetScheduledRecordingsResponse } from "@lukehagar/plexjs/models/operations";
...
| `result`                                                                                                       | [operations.GetScheduledRecordingsResponseBody](../../models/operations/getscheduledrecordingsresponsebody.md) | :heavy_check_mark:                                                                                             | N/A                                                                                                            |