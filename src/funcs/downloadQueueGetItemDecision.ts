 ...
 */
export function downloadQueueGetItemDecision(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetItemDecisionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/downloadQueue/{queueId}/item/{itemId}/decision")(
    pathParams,
  );
