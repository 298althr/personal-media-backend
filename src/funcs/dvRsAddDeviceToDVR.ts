 ...
 */
export function dvRsAddDeviceToDVR(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.AddDeviceToDVRRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.AddDeviceToDVRResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.fail("4XX"),
