 ...
 */
export function contentGetFolders(
  client: PlexAPICore,
...
> {
  ...
  const path = pathToFunc("/library/sections/{sectionId}/location")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetFoldersResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
