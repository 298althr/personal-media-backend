 ...
 */
export function libraryDeleteMediaItem(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteMediaItemRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    mediaItem: encodeSimple("mediaItem", payload.mediaItem, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  const path = pathToFunc("/library/metadata/{ids}/media/{mediaItem}")(
    pathParams,
  );
