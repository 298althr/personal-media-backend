 ...
 */
export function libraryGetPartIndex(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetPartIndexRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/parts/{partId}/indexes/{index}")(
    pathParams,
  );
