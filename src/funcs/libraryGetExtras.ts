 ...
 */
export function libraryGetExtras(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetExtrasRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/metadata/{ids}/extras")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetExtrasResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.fail("4XX"),
