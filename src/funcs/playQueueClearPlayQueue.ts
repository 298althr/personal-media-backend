 ...
 */
export function playQueueClearPlayQueue(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ClearPlayQueueRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/playQueues/{playQueueId}/items")(pathParams);
