 ...
 */
export function statusTerminateSession(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.TerminateSessionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/status/sessions/terminate")();
