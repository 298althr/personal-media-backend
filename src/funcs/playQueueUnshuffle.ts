 ...
 */
export function playQueueUnshuffle(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UnshuffleRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/playQueues/{playQueueId}/unshuffle")(pathParams);
