 ...
 */
export function contentGetSonicPath(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetSonicPathRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/sections/{sectionId}/computePath")(
    pathParams,
  );
