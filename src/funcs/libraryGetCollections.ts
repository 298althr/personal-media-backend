 ...
 */
export function libraryGetCollections(
  client: PlexAPICore,
...
> {
  ...
  const path = pathToFunc("/library/sections/{sectionId}/collections")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetCollectionsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.fail("4XX"),
