 ...
 */
export function libraryUpdateItemArtwork(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateItemArtworkRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/metadata/{ids}/{element}")(pathParams);
