 ...
 */
export function hubsGetPromotedHubs(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetPromotedHubsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/hubs/promoted")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetPromotedHubsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.fail("4XX"),
