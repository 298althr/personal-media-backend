 ...
 */
export function libraryDetectCredits(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DetectCreditsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/metadata/{ids}/credits")(pathParams);
