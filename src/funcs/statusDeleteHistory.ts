 ...
 */
export function statusDeleteHistory(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteHistoryRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.DeleteHistoryResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.fail([404, "4XX"]),
