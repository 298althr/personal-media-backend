 ...
 */
export function downloadQueueRestartProcessingDownloadQueueItems(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RestartProcessingDownloadQueueItemsRequest$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/downloadQueue/{queueId}/items/{itemId}/restart")(
    pathParams,
  );
