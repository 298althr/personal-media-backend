 ...
 */
export function subscriptionsGetSubscription(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetSubscriptionRequest$outboundSchema.parse(value),
  ...
  const query = encodeFormQuery({
    "includeGrabs": payload.includeGrabs,
    "includeStorage": payload.includeStorage,
  });
