 ...
 */
export function dvRsTuneChannel(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.TuneChannelRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/livetv/dvrs/{dvrId}/channels/{channel}/tune")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.TuneChannelResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.fail("4XX"),
