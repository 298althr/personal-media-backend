 ...
 */
export function hubsGetContinueWatching(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetContinueWatchingRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/hubs/continueWatching")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetContinueWatchingResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.fail("4XX"),
