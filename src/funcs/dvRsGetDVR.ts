...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetDVRRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/livetv/dvrs/{dvrId}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetDVRResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.fail("4XX"),
