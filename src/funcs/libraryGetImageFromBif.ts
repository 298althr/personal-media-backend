 ...
 */
export function libraryGetImageFromBif(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetImageFromBifRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    offset: encodeSimple("offset", payload.offset, {
      explode: false,
      charEncoding: "percent",
    }),
  ...
  const path = pathToFunc("/library/parts/{partId}/indexes/{index}/{offset}")(
    pathParams,
  );
