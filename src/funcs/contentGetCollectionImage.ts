 ...
 */
export function contentGetCollectionImage(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetCollectionImageRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    updatedAt: encodeSimple("updatedAt", payload.updatedAt, {
      explode: false,
      charEncoding: "percent",
    }),
  };
