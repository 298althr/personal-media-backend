 ...
 */
export function contentGetAllLeaves(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAllLeavesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/sections/{sectionId}/allLeaves")(
    pathParams,
  );
