 ...
 */
export function libraryAnalyzeMetadata(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.AnalyzeMetadataRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/metadata/{ids}/analyze")(pathParams);

  const query = encodeFormQuery({
    "artOffset": payload.artOffset,
