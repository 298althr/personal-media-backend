 ...
 */
export function libraryRefreshSection(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.RefreshSectionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/sections/{sectionId}/refresh")(pathParams);
