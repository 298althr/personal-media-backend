 ...
 */
export function libraryGetAllItemLeaves(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetAllItemLeavesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/metadata/{ids}/allLeaves")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAllItemLeavesResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.fail("4XX"),
