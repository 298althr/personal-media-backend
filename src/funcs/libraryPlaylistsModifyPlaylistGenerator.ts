 ...
 */
export function libraryPlaylistsModifyPlaylistGenerator(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ModifyPlaylistGeneratorRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/playlists/{playlistId}/items/{generatorId}")(
    pathParams,
  );
