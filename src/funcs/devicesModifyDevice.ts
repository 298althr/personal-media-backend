 ...
 */
export function devicesModifyDevice(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ModifyDeviceRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ModifyDeviceResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.fail([404, "4XX"]),
