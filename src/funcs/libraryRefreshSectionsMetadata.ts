 ...
 */
export function libraryRefreshSectionsMetadata(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RefreshSectionsMetadataRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/sections/refresh")();
