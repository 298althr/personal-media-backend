...
import { encodeDeepObjectQuery, encodeSimple } from "../lib/encodings.js";
 ...
 */
export function subscriptionsEditSubscriptionPreferences(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.EditSubscriptionPreferencesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/media/subscriptions/{subscriptionId}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, shared.MediaContainerWithSubscription$inboundSchema),
