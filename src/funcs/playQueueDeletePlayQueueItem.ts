 ...
 */
export function playQueueDeletePlayQueueItem(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeletePlayQueueItemRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    playQueueId: encodeSimple("playQueueId", payload.playQueueId, {
      explode: false,
      charEncoding: "percent",
    }),
    playQueueItemId: encodeSimple("playQueueItemId", payload.playQueueItemId, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  const path = pathToFunc("/playQueues/{playQueueId}/items/{playQueueItemId}")(
    pathParams,
  );
