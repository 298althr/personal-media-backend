 ...
 */
export function statusGetBackgroundTasks(
  client: PlexAPICore,
...
> {
  const path = pathToFunc("/status/sessions/background")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetBackgroundTasksResponse$inboundSchema),
    M.fail("4XX"),
    M.fail("5XX"),
  )(response, req);
  if (!result.ok) {
