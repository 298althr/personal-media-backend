 ...
 */
export function libraryStartAnalysis(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.StartAnalysisRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/sections/{sectionId}/analyze")(pathParams);
