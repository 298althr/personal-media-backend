 ...
 */
export function libraryDetectVoiceActivity(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DetectVoiceActivityRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/metadata/{ids}/voiceActivity")(pathParams);
