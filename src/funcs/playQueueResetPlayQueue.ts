 ...
 */
export function playQueueResetPlayQueue(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ResetPlayQueueRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/playQueues/{playQueueId}/reset")(pathParams);
