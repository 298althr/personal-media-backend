 ...
 */
export function libraryPlaylistsMovePlaylistItem(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.MovePlaylistItemRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    ...
    playlistItemId: encodeSimple("playlistItemId", payload.playlistItemId, {
      explode: false,
      charEncoding: "percent",
    }),
  };
