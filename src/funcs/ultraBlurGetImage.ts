 ...
 */
export function ultraBlurGetImage(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetImageRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/services/ultrablur/image")();

  const query = encodeFormQuery({
    "bottomLeft": payload.bottomLeft,
    "bottomRight": payload.bottomRight,
    "height": payload.height,
    "noise": payload.noise,
    "topLeft": payload.topLeft,
    "topRight": payload.topRight,
    "width": payload.width,
  });
