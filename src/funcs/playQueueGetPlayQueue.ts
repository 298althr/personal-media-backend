 ...
 */
export function playQueueGetPlayQueue(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetPlayQueueRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/playQueues/{playQueueId}")(pathParams);

  const query = encodeFormQuery({
    "center": payload.center,
    "includeAfter": payload.includeAfter,
    "includeBefore": payload.includeBefore,
    "own": payload.own,
