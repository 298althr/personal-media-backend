 ...
 */
export function searchVoiceSearchHubs(
  client: PlexAPICore,
  request: operations.VoiceSearchHubsRequest,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.VoiceSearchHubsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.VoiceSearchHubsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.fail([400, "4XX"]),
