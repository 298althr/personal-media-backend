 ...
 */
export function activitiesCancelActivity(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CancelActivityRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    activityId: encodeSimple("activityId", payload.activityId, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  const path = pathToFunc("/activities/{activityId}")(pathParams);
