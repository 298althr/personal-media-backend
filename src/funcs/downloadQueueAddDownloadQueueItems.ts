 ...
 */
export function downloadQueueAddDownloadQueueItems(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.AddDownloadQueueItemsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/downloadQueue/{queueId}/add")(pathParams);
