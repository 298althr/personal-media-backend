 ...
 */
export function libraryCollectionsAddCollectionItems(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.AddCollectionItemsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/collections/{collectionId}/items")(
    pathParams,
  );
