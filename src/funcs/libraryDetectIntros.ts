 ...
 */
export function libraryDetectIntros(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DetectIntrosRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/metadata/{ids}/intro")(pathParams);
