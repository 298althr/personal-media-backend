 ...
 */
export function providerDeleteMediaProvider(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteMediaProviderRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/media/providers/{provider}")(pathParams);
