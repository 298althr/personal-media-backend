 ...
 */
export function subscriptionsCancelGrab(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CancelGrabRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/media/grabbers/operations/{operationId}")(
    pathParams,
  );
