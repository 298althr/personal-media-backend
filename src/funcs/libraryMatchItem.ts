 ...
 */
export function libraryMatchItem(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.MatchItemRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/metadata/{ids}/match")(pathParams);
