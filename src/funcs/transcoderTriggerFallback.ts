 ...
 */
export function transcoderTriggerFallback(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.TriggerFallbackRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/{transcodeType}/:/transcode/universal/fallback")(
    pathParams,
  );
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["404", "412", "4XX", "500", "5XX"],
