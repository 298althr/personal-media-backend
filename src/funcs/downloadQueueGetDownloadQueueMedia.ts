 ...
 */
export function downloadQueueGetDownloadQueueMedia(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetDownloadQueueMediaRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/downloadQueue/{queueId}/item/{itemId}/media")(
    pathParams,
  );
