...
> {
  const parsed = safeParse(
    request,
    (value) => operations.AddSectionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/sections/all")();
  ...
  const query = queryJoin(
    ...
    encodeFormQuery({
      "agent": payload.agent,
      "importFromiTunes": payload.importFromiTunes,
      "language": payload.language,
      "locations": payload.locations,
      "metadataAgentProviderGroupId": payload.metadataAgentProviderGroupId,
      "name": payload.name,
