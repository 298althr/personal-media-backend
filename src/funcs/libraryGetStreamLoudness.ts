 ...
 */
export function libraryGetStreamLoudness(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetStreamLoudnessRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/streams/{streamId}/loudness")(pathParams);
