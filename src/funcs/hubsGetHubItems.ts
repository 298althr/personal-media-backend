 ...
 */
export function hubsGetHubItems(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetHubItemsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/hubs/items")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetHubItemsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.fail([404, "4XX"]),
