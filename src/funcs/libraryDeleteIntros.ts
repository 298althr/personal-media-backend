 ...
 */
export function libraryDeleteIntros(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteIntrosRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/sections/{sectionId}/intros")(pathParams);
