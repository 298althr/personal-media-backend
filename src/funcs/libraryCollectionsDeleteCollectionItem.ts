 ...
 */
export function libraryCollectionsDeleteCollectionItem(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteCollectionItemRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/collections/{collectionId}/items/{itemId}")(
    pathParams,
  );
