 ...
 */
export function libraryListSonicallySimilar(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListSonicallySimilarRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/metadata/{ids}/nearest")(pathParams);

  const query = encodeFormQuery({
    "excludeGrandparentID": payload.excludeGrandparentID,
    "excludeParentID": payload.excludeParentID,
    "limit": payload.limit,
