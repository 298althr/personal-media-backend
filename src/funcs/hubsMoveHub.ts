...
> {
  const parsed = safeParse(
    request,
    (value) => operations.MoveHubRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/hubs/sections/{sectionId}/manage/move")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.MoveHubResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.fail([403, 404, "4XX"]),
