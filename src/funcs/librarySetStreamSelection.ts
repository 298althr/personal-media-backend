 ...
 */
export function librarySetStreamSelection(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.SetStreamSelectionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/parts/{partId}")(pathParams);

  const query = encodeFormQuery({
    "allParts": payload.allParts,
    "audioStreamID": payload.audioStreamID,
    "subtitleStreamID": payload.subtitleStreamID,
  });
