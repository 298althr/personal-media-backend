 ...
 */
export function libraryGetMediaPart(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetMediaPartRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    changestamp: encodeSimple("changestamp", payload.changestamp, {
      explode: false,
    ...
    partId: encodeSimple("partId", payload.partId, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  const path = pathToFunc("/library/parts/{partId}/{changestamp}/{filename}")(
    pathParams,
  );
  ...
  const doResult = await client._do(req, {
    context,
    errorCodes: ["403", "404", "4XX", "503", "509", "5XX"],
