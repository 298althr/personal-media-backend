 ...
 */
export function librarySplitItem(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.SplitItemRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/metadata/{ids}/split")(pathParams);
