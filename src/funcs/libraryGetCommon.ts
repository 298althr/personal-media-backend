 ...
 */
export function libraryGetCommon(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetCommonRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/sections/{sectionId}/common")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetCommonResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.fail([400, 404, "4XX"]),
