 ...
 */
export function libraryAddSubtitles(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.AddSubtitlesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/metadata/{ids}/subtitles")(pathParams);

  const query = encodeFormQuery({
    "forced": payload.forced,
    "format": payload.format,
    "hearingImpaired": payload.hearingImpaired,
