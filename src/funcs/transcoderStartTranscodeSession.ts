 ...
 */
export function transcoderStartTranscodeSession(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.StartTranscodeSessionRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    extension: encodeSimple("extension", payload.extension, {
      explode: false,
