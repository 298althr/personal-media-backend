 ...
 */
export function subscriptionsGetScheduledRecordings(
  client: PlexAPICore,
...
> {
  const path = pathToFunc("/media/subscriptions/scheduled")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetScheduledRecordingsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.fail([403, "4XX"]),
