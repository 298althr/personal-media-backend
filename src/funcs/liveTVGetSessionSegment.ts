 ...
 */
export function liveTVGetSessionSegment(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetSessionSegmentRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    consumerId: encodeSimple("consumerId", payload.consumerId, {
      explode: false,
      charEncoding: "percent",
    }),
    segmentId: encodeSimple("segmentId", payload.segmentId, {
      explode: false,
      charEncoding: "percent",
    }),
