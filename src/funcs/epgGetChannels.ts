 ...
 */
export function epgGetChannels(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetChannelsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/livetv/epg/channels")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetChannelsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.fail([404, "4XX"]),
