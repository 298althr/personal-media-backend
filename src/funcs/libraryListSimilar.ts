 ...
 */
export function libraryListSimilar(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListSimilarRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/metadata/{ids}/similar")(pathParams);
