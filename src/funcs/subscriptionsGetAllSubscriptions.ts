 ...
 */
export function subscriptionsGetAllSubscriptions(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAllSubscriptionsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/media/subscriptions")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAllSubscriptionsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.fail([403, "4XX"]),
