 ...
 */
export function librarySetItemPreferences(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.SetItemPreferencesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/metadata/{ids}/prefs")(pathParams);
