 ...
 */
export function playlistListPlaylists(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListPlaylistsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListPlaylistsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.fail("4XX"),
