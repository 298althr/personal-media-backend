 ...
 */
export function devicesSetDevicePreferences(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.SetDevicePreferencesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/media/grabbers/devices/{deviceId}/prefs")(
    pathParams,
  );
