 ...
 */
export function playQueueShuffle(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ShuffleRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/playQueues/{playQueueId}/shuffle")(pathParams);
