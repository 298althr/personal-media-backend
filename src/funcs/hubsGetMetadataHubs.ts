 ...
 */
export function hubsGetMetadataHubs(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetMetadataHubsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/hubs/metadata/{metadataId}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetMetadataHubsResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.fail([400, "4XX"]),
