 ...
 */
export function libraryDeleteIndexes(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeleteIndexesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/sections/{sectionId}/indexes")(pathParams);
