 ...
 */
export function libraryEmptyTrash(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.EmptyTrashRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/sections/{sectionId}/emptyTrash")(
    pathParams,
  );
