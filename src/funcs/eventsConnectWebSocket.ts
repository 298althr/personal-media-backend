 ...
 */
export function eventsConnectWebSocket(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ConnectWebSocketRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/:/websocket/notifications")();
