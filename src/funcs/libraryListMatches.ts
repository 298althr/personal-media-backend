 ...
 */
export function libraryListMatches(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListMatchesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/library/metadata/{ids}/matches")(pathParams);
