 ...
 */
export function eventsGetNotifications(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetNotificationsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/:/eventsource/notifications")();
