 ...
 */
export function devicesGetAvailableGrabbers(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAvailableGrabbersRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/media/grabbers")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAvailableGrabbersResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.fail("4XX"),
