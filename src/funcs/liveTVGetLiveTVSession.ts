 ...
 */
export function liveTVGetLiveTVSession(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetLiveTVSessionRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/livetv/sessions/{sessionId}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetLiveTVSessionResponse$inboundSchema, {
      hdrs: true,
      key: "Result",
    }),
    M.fail("4XX"),
