 ...
 */
export function libraryListPersonMedia(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListPersonMediaRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    personId: encodeSimple("personId", payload.personId, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  const path = pathToFunc("/library/people/{personId}/media")(pathParams);
