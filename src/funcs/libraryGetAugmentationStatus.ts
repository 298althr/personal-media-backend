 ...
 */
export function libraryGetAugmentationStatus(
  client: PlexAPICore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAugmentationStatusRequest$outboundSchema.parse(value),
  ...
  const pathParams = {
    augmentationId: encodeSimple("augmentationId", payload.augmentationId, {
      explode: false,
      charEncoding: "percent",
    }),
  };
  const path = pathToFunc("/library/metadata/augmentations/{augmentationId}")(
    pathParams,
  );
