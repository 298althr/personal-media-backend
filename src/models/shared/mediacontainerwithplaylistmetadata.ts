...
/** @internal */
export const PlaylistType$inboundSchema: z.ZodType<PlaylistTypeOpen, unknown> =
  openEnums.inboundSchema(PlaylistType);
  ...
  z.ZodType<MediaContainerWithPlaylistMetadataMetadatum, unknown> =
    collectExtraKeys$(
      z.object({
        ...
        Guid: types.optional(z.array(z.lazy(() =>
          MediaContainerWithPlaylistMetadataGuid$inboundSchema
        ))),
...
export const MediaContainerWithPlaylistMetadataMediaContainer$inboundSchema:
  z.ZodType<MediaContainerWithPlaylistMetadataMediaContainer, unknown> = z
    .object({
