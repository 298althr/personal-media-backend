...
export type Items = {
  ...
  guids?: Array<ItemsGuid> | undefined;
  /**
...
/** @internal */
export const ItemsGuid$inboundSchema: z.ZodType<ItemsGuid, unknown> = z.object({
  id: types.string(),
});

export function itemsGuidFromJSON(
  jsonString: string,
): SafeParseResult<ItemsGuid, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => ItemsGuid$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'ItemsGuid' from JSON`,
  );
}
...
export const Items$inboundSchema: z.ZodType<Items, unknown> = collectExtraKeys$(
  z.object({
    ...
    Guid: types.optional(z.array(z.lazy(() => ItemsGuid$inboundSchema))),
    ...
    MetadataItem: types.optional(z.array(z.lazy(() => Items$inboundSchema))),
  }).catchall(z.any()),
